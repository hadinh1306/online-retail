...
I'm also curious of the RFM data, so I'll output `rfm_df` to further investigate it through visualization.

I will export csv files to visualize data using Tableau. 
